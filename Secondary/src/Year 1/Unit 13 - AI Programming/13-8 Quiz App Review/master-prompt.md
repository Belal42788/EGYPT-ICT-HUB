...
> **Lesson**: Quiz App Review (`13-8`)
> **Source**: `ICT_En_Sec1_T1.pdf`, printed pages 194–195 (book numbering)
> **Output filename**: `quiz-app-review.html`
...
- Engine for this lesson (`ai`): Teachable-Machine style demo (no real training).
...
Save the site as `quiz-app-review.html` in this same folder.
...
```
Warm Up
Summarize your key takeaways from the quiz app based on the points below.
1) What is the theme of the quiz you created?
Examples:
• A quiz about space.
• A quiz about animals.
2) What did you learn about HTML?
Examples:
• You can specify the app title using the <title> tag.
• Assigning a class allows you to reference the element in CSS.
3) What did you learn about CSS?
Examples:
• You can set the background color and font using the body selector.
• You can specify the size and color of choice buttons using the .choice class selector.
4) What did you learn about JavaScript?
Examples:
• Multiple options are handled using an array named choices.
• The text color for correct or incorrect answers is changed using an if...else statement.
Categorize the points you summarized into “Things I already knew” and “Things I didn’t know.”
For the things you didn’t know, ask the AI to explain them further to deepen your understanding.
Examples of questions to ask the AI:
• “Tell me what the code <p id='result'></p> does.”
• “What does background: #f5f5f5; mean?”
Try
196
Information Study
Point!
...
13-9
In this lesson, you will use generative AI to generate code for a simple block breaker game using JavaScript.
Note: You will present your work in a future class.
Warm Up
Open copilot.microsoft.com in your browser, sign in, and launch Copilot.
1. Generate the Code Enter the following prompt into Copilot:
“Create a simple block breaker game. Please provide separate code for HTML, CSS, and JavaScript.”
2. Run the Code Copy and paste the generated code into the HTML, CSS, and JavaScript tabs in WebDen and
run it.
(Note: Since generative AI produces different code each time, your result may differ from others.)
3. Understand the Code Give the following prompt to the AI and read its explanation:
“Explain this code.”
How much of the AI-written code can you understand?
Note: Rename the Copilot chat to “Block Breaker Development” to make it easier to review your interactions
in future lessons.
Point!
```
