...
> **Lesson**: Block Breaker Summary (`13-11`)
> **Source**: `ICT_En_Sec1_T1.pdf`, printed pages 200–200 (book numbering)
> **Output filename**: `block-breaker-summary.html`
...
Save the site as `block-breaker-summary.html` in this same folder.
...
```
Exercise
Practice your presentation for the next class.
Try
```
