...
> **Lesson**: Developing a Quiz App (`13-7`)
> **Source**: `ICT_En_Sec1_T1.pdf`, printed pages 192–193 (book numbering)
> **Output filename**: `developing-a-quiz-app.html`
...
Save the site as `developing-a-quiz-app.html` in this same folder.
...
“Create a simple multiple-choice quiz app. Include only one question. Please provide separate code for
HTML, CSS, and JavaScript.”
Paste the outputted code into the HTML, CSS, and JavaScript tabs in WebDen and run it.
(Note: Since using Generative AI results in different code each time, this is just one example.)
Modify the HTML, CSS, and JavaScript code to change the question text or the answer.
Give the following prompt to the Generative AI and read the explanation:
“Explain this code.”
Rename the Copilot chat thread to “Developing a Quiz App”.
194
Give the following prompt to the Generative AI:
“Make it 3 questions.”
Paste the outputted code into the HTML, CSS, and JavaScript tabs in WebDen and run it.
(Note: Since using Generative AI results in different code each time, this is just one example.)
Modify the HTML, CSS, and JavaScript code to change the number of questions.
Give the following prompt to the Generative AI and read the explanation:
“Explain this code.”
Exercise
Let’s customize the quiz app you created.
Examples:
• Increase the number of choices (options).
• Display the percentage of correct answers (score).
