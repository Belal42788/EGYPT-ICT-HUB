...
> **Lesson**: Block Breaker Development Presentation (`13-12`)
> **Source**: `ICT_En_Sec1_T1.pdf`, printed pages 201–202 (book numbering)
> **Output filename**: `block-breaker-development-presentation.html`
...
Save the site as `block-breaker-development-presentation.html` in this same folder.
...
```
Warm Up
You will present the block breaker game created in previous lessons based on the following points.
